        ...
        <Page size="A4" style={styles.page}>
          ...
          <View wrap={false}>
            ...
            <View style={styles.table}>
              {/* thead */}
              <View style={styles.table__row}>
                <Text style={styles.table__head}>CUMMULATIVE CREDIT UNIT</Text>
                <Text style={styles.table__head}>CUMMULATIVE GRADE POINT</Text>
                <Text style={styles.table__head}>
              ...
              {/* tbody */}
              <View style={styles.table__row}>
                <Text style={styles.table__cell}>{sumUnit.toPrecision(3)}</Text>
